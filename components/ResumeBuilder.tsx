          ...
          {activeMainTab === 'customize' && (
            <div className="space-y-8 animate-fadeIn">
               ...
               <div className="grid grid-cols-2 gap-2">
                 <button onClick={() => window.print()} className="py-4 bg-white text-black font-bold uppercase tracking-widest text-xs rounded hover:bg-gray-200 transition-colors shadow">
                   Print PDF
                 </button>
                 <button onClick={handleDownloadDocx} disabled={isGenerating} className="py-4 bg-blue-600 text-white font-bold uppercase tracking-widest text-xs rounded hover:bg-blue-500 transition-colors shadow flex items-center justify-center gap-2">
                    {isGenerating ? 'Converting...' : 'Download DOCX'}
                 </button>
               </div>
            </div>
          )}
